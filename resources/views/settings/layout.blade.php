...
<head>
    ...
    <style>
        *{box-sizing:border-box}
        ...
        html.dark-mode{--ink:#f4f4f5;--muted:#a1a1aa;--line:rgba(255,255,255,.08);--bg:#121214;--card:#18181b}
        ...
        .settings-heading{display:flex;align-items:center;gap:12px}.settings-menu{display:none;width:42px;height:42px;border:1px solid var(--line);border-radius:11px;background:var(--card);color:var(--ink);font-size:20px;cursor:pointer}
        ...
        .current-user{display:flex;align-items:center;gap:10px;background:var(--card);border:1px solid var(--line);padding:8px 10px;border-radius:13px}
        ...
        .settings-tabs{display:flex;gap:8px;flex-wrap:wrap;background:var(--card);border:1px solid var(--line);padding:8px;border-radius:15px;margin-bottom:22px}
        ...
        .panel{background:transparent;border:1px solid var(--line);border-radius:16px;box-shadow:0 10px 30px rgba(15,23,42,.04);padding:22px;margin-bottom:18px}
        .panel-head{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:18px;background:transparent}.panel-head h2{margin:0;font-size:21px}.panel-head p{margin:5px 0 0;color:var(--muted)}
        .grid{display:grid;gap:16px}.stats-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.stat-card{background:var(--card);border:1px solid var(--line);border-radius:16px;padding:20px}.stat-card b{display:block;font-size:30px;margin-top:10px}.stat-card span{color:var(--muted);font-weight:700}
        .action-card{text-decoration:none;color:inherit}.action-card:hover{border-color:#f3aab1;transform:translateY(-1px)}
        .btn{display:inline-flex;align-items:center;justify-content:center;gap:6px;min-height:40px;padding:0 14px;border:1px solid var(--line);border-radius:10px;background:var(--card);color:var(--ink);font-weight:800;text-decoration:none;cursor:pointer;font-family:inherit}
        .btn.primary{background:var(--red);border-color:var(--red);color:#fff}
        .btn.danger{color:#b42332;border-color:#f1bbc1}
        .btn.soft{background:var(--bg)}
        .btn.small{min-height:34px;padding:0 10px;font-size:13px}
        .toolbar{display:flex;gap:10px;align-items:center;flex-wrap:wrap}.search{display:flex;gap:8px;flex:1}.search input{min-width:220px;flex:1;background:var(--card);border:1px solid var(--line);color:var(--ink)}
        input,textarea,select{width:100%;border:1px solid #dbe1e9;border-radius:10px;padding:11px 12px;background:var(--card);color:var(--ink);font:inherit;outline:none}input:focus,textarea:focus,select:focus{border-color:var(--red);box-shadow:0 0 0 3px rgba(220,38,55,.08)}textarea{min-height:100px;resize:vertical}
        ...
        .checkbox-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.check-card{display:flex;gap:9px;align-items:flex-start;border:1px solid var(--line);border-radius:11px;padding:12px;background:var(--card);color:var(--ink)}.check-card input{width:auto;margin-top:3px}.check-card strong,.check-card small{display:block}.check-card small{color:var(--muted);margin-top:3px}
        ...
        /* Dark Mode Overrides for Settings Section */
        html.dark-mode .btn:not(.primary):not(.danger):not(.success){
            background:rgba(255,255,255,.08)!important;
            border-color:rgba(255,255,255,.14)!important;
            color:#f4f4f5!important;
        }
        html.dark-mode .btn:not(.primary):not(.danger):not(.success):hover{
            background:rgba(255,255,255,.15)!important;
            border-color:rgba(255,255,255,.25)!important;
            color:#ffffff!important;
        }
        html.dark-mode .btn.danger{
            background:rgba(220,38,55,.15)!important;
            border-color:rgba(220,38,55,.3)!important;
            color:#f87171!important;
        }
        html.dark-mode .btn.danger:hover{
            background:rgba(220,38,55,.25)!important;
            border-color:rgba(220,38,55,.5)!important;
        ...
        html.dark-mode .settings-tabs a{
            color:#a1a1aa!important;
        }
        html.dark-mode .settings-tabs a.active,
        html.dark-mode .settings-tabs a:hover{
            background:rgba(220,38,55,.15)!important;
            color:#f87171!important;
        }
        html.dark-mode .current-user{
            background:#18181b!important;
            border-color:rgba(255,255,255,.08)!important;
        }
        ...
        html.dark-mode .permission-table th:first-child,
        html.dark-mode .permission-table td:first-child{
            background:#18181b!important;
        }
