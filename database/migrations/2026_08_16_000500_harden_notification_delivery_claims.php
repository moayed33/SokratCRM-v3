...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::hasTable('notification_deliveries') && ! Schema::hasColumn('notification_deliveries', 'claim_token')) {
        ...
        if (Schema::hasTable('notification_deliveries') && ! Schema::hasIndex('notification_deliveries', 'notification_delivery_due_index')) {
            Schema::table('notification_deliveries', function (Blueprint $table): void {
