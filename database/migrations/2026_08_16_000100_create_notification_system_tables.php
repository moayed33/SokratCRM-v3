...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('notification_occurrences')) {
        ...
        if (! Schema::hasTable('notification_deliveries')) {
            Schema::create('notification_deliveries', function (Blueprint $table): void {
                $table->id();
                $table->unsignedBigInteger('notification_occurrence_id');
                $table->foreign('notification_occurrence_id')->references('id')->on('notification_occurrences')->cascadeOnDelete();
                $table->string('channel', 20);
